...
`position_nudge_repel` is useful for adjusting the starting position of
text labels before they are repelled from data points.
...
- x, y:
  ...
  Amount of horizontal and vertical distance to move. Same units as the
