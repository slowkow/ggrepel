...
|`segment.linewidth`  | `1`     | another way to specify line segment thickness
...
|`label.color.alpha` | `1`      | alpha value of the label border color, [0, 1]
|`label.fill.alpha` | `1`      | alpha value of the label fill color, [0, 1]
...
### Label border alpha and label fill alpha

We can change the alpha value of the label border and label fill separately,
for finer control of the visual style of text labels.

```{r label-alpha, echo=TRUE, fig.width=5, fig.height=4}
set.seed(42)
p <- ggplot(dat, aes(wt, mpg, label = car)) +
  geom_point(color = "red")
